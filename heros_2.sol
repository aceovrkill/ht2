...
contract HerosV2 is Ownable {
    ...
    uint256 public _rewardRate = 75; // 0.75%
    ...
    function _takeOperations(uint256 tAmount, uint256 feeType) private returns (uint256) {
        ...
        uint256 tMarketing = calculateFee(tAmount, _marketingFee, taxMultiplicator);
        ...
        tTransferAmount = tAmount - tFee - tLiquidity - tMarketing - tCharity - tDevelopment;
